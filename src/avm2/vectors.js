  ...
  vector.callable = function (object) {
    ...
    if (length !== undefined) {
      ...
      for (var i = 0; i < length; i++) {
        v.asSetNumericProperty(i, object.asGetNumericProperty(i));
      }
      return v;
    }
    unexpected();
