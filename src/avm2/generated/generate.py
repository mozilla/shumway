...
def main():
    ...
    compile_abc("avm1lib", ["AS2Utils.as", "AS2Broadcaster.as", "AS2MovieClip.as", "AS2Button.as", "AS2TextField.as", "AS2Key.as", "AS2Mouse.as", "AS2Stage.as", "AS2System.as", "AS2Color.as", "AS2Globals.as"], deps=["builtin", "playerGlobal"], configs=configs)
