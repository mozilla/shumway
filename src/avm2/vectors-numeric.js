...
var TypedArrayVector = (function () {
  ...
  vector.prototype.asSetNumericProperty = function (i, v) {
    if (i < 0 || i > this._length ||
        i === this._length && this._fixed) {
      throwError("RangeError", Errors.OutOfRangeError, i, this._length);
    }
    if (i === this._length) {
