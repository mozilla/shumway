      ...
      Promise.when.apply(Promise, promiseQueue).then(function () {
        ...
        if (!root) {
          ...
          if (!loader._isAvm2Enabled) {
            ...
            avm1Context.globals.asSetProperty(undefined, '_root', 0, as2Object);
            avm1Context.globals.asSetProperty(undefined, '_level0', 0, as2Object);
            avm1Context.globals.asSetProperty(undefined, '_level1', 0, as2Object);
