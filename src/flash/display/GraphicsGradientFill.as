...
public final class GraphicsGradientFill implements IGraphicsFill, IGraphicsData {
    ...
    public function get type():String { notImplemented("type"); return ""; }
    public function set type(value:String) { notImplemented("type"); }
    public var colors:Array;
    public var alphas:Array;
    public var ratios:Array;
    public var matrix:Matrix;
    public function get spreadMethod():String { notImplemented("spreadMethod"); return ""; }
    public function set spreadMethod(value:String) { notImplemented("spreadMethod"); }
    public function get interpolationMethod():String { notImplemented("interpolationMethod"); return ""; }
