...
public final class GradientBevelFilter extends BitmapFilter {
  public function GradientBevelFilter(distance: Number = 4, angle: Number = 45,
  ...
  public override function clone(): BitmapFilter {
    return new GradientBevelFilter(distance, angle, colors, alphas, ratios, blurX, blurY, strength,
