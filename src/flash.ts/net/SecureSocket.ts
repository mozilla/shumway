...
module Shumway.AVM2.AS.flash.net {
  ...
  export class SecureSocket extends flash.net.Socket {
    ...
    connectionResultToCertStatus: (connectionResult: number /*uint*/) => string;
    ...
    getConnectionResultSet(): boolean {
      notImplemented("public flash.net.SecureSocket::getConnectionResultSet"); return;
    }
    getConnectionResult(): number /*uint*/ {
      notImplemented("public flash.net.SecureSocket::getConnectionResult"); return;
    }
  }
}
