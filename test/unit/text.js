(function textTests() {
  ...
  unitTests.push(function getObjectsUnderPoint() {
    ...
    eq(textRuns[0].beginIndex, 0); eq(textRuns[0].endIndex, 24);
    eq(textRuns[1].beginIndex, 24); eq(textRuns[1].endIndex, 27);
    eq(textRuns[2].beginIndex, 27); eq(textRuns[2].endIndex, 29);
    eq(textRuns[3].beginIndex, 29); eq(textRuns[3].endIndex, 53);
    eq(textRuns[4].beginIndex, 53); eq(textRuns[4].endIndex, 56);
    eq(textRuns[5].beginIndex, 56); eq(textRuns[5].endIndex, 64);
    eq(textRuns[6].beginIndex, 64); eq(textRuns[6].endIndex, 65);
  });
