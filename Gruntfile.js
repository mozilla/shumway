  ...
  grunt.initConfig({
    ...
    exec: {
      ...
      test_avm2_acceptance: {
        maxBuffer: Infinity,
        cmd: 'utils/jsshell/js build/ts/shell.js -x -v test/avm2/acceptance_pass.json | egrep -o "(PASSED|FAILED|EXCEPTED|TIMEDOUT)" | sort | uniq -c | tee test/avm2/acceptance_results.tmp && ' +
